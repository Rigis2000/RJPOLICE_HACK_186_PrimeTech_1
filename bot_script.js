    ...
    if (response) {
        switch (response.toLowerCase()) {
            case "navigation":
                ...
                break;
            case "give feedback":
                setTimeout(()=>{newChatLi.querySelector("p").textContent = "We appreciate your feedback! Please let us know your thoughts, visit the feedback page here:";},500); break;
            ...
            case "home":
                setTimeout(()=>{newChatLi.querySelector("p").textContent = "Click here to go to home page";},500); break;
            case "login":
                setTimeout(()=>{newChatLi.querySelector("p").textContent = "Click here to go to login page";},500); break;
            case "feedback":
                setTimeout(()=>{newChatLi.querySelector("p").textContent = "Click here to go to feedback page";},500); break;
            case "customer care":
